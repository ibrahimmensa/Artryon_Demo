...
namespace BNB
{
    ...
    public class BanubaSDKManager : MonoBehaviour
    {
        ...
        [SerializeField]
        private BanubaSDKBridge.bnb_rect_fit_mode_t _fitMode = BanubaSDKBridge.bnb_rect_fit_mode_t.bnb_fit_inside;
        ...
        static public BanubaSDKBridge.bnb_rect_fit_mode_t FitMode
        {
            get {
                return instance._fitMode;
            }
        }
