...
namespace BNB
{
    public static class BanubaSDKBridge
    {
        ...
        public struct bnb_recognizer_features_id_t
        {
            ...
            public ulong action_units_antijitter;
            public ulong face_skin_segm;
            public ulong pupillary_distance;
            public ulong frown_detector;
            public ulong teeth_tone;
        };
        ...
        /// </returns>
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void bnb_fit_rects_aspect_ratio(ref bnb_pixel_rect_t source_rect, ref bnb_pixel_rect_t target_rect, bnb_rect_fit_mode_t mode, out IntPtr error);
        ...
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void get_extended_static_pos_data(IntPtr verts, IntPtr inds);


        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern int get_extended_static_pos_vertices_size();


        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern int get_extended_static_pos_indices_size();
        ...
        /// <returns>hand gesture enum</returns>
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern bnb_hand_data_t bnb_frame_data_get_hand(IntPtr fd, int width, int height, bnb_rect_fit_mode_t mode, bool flip_y, out IntPtr error);
