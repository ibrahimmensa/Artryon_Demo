...
namespace BNB
{
    ...
    public class CameraDevice : MonoBehaviour
    {
        ...
        private Pinner<Color32[]> _dataPinner;
        ...
        {
            if (_texSize != (localTexture.width * localTexture.height)) {
                _texSize = localTexture.width * localTexture.height;
                _dataPinner = new Pinner<Color32[]>(localTexture.GetPixels32());
            }
            ...
            var ImageData = new CameraTextureData();
            ImageData.angle = 0;
            ImageData.isVerticallyFlipped = false;
            ImageData.isRotated90 = false;
            onCameraTexture?.Invoke(localTexture, ImageData);
        }
        ...
        private void UpdateCameraImage()
        {
            ...
            bool isVert = _webCamTexture.videoRotationAngle == 90 || _webCamTexture.videoRotationAngle == 180;
            _dataChanged = cameraTextureData.angle != _webCamTexture.videoRotationAngle
                           || cameraTextureData.isVerticallyFlipped != isVert;
            ...
            if (_texSize != _data.Length || _dataChanged) {
                _texSize = _webCamTexture.width * _webCamTexture.height;
                _data = new Color32[_texSize];
                _dataPinner = new Pinner<Color32[]>(_data);
            }
