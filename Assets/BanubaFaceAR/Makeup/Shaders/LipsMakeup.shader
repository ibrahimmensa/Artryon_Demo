    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(vertData v)
            {
                ...
                float4 vert = mul(_BNBCameraScale, o.vertex);
                vert = mul(_AddRotation, vert);

                float2 cam_uv = float2(vert.x, vert.y);
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                if(_IsMatt > 0)
                {
                    ...
                    lips_brightness_contrast.y *= v_scale;
