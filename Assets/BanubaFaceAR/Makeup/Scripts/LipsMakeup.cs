...
namespace BNB.Makeup
{
    public class LipsMakeup : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            BanubaSDKBridge.bnb_recognizer_insert_feature(BanubaSDKManager.instance.Recognizer, featuresID.lips_shine, out error);
        ...
        private void OnDestroy()
        {
            var featuresID = BanubaSDKBridge.bnb_recognizer_get_features_id();
            IntPtr error = IntPtr.Zero;
            BanubaSDKBridge.bnb_recognizer_remove_feature(BanubaSDKManager.instance.Recognizer, featuresID.lips_shine, out error);
            Utils.CheckError(error);
