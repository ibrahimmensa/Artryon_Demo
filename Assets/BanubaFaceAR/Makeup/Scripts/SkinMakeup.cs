...
namespace BNB.Makeup
{
    public class SkinMakeup : MonoBehaviour
    {
        ...
        private readonly int _BluredTex = Shader.PropertyToID("_BluredTex");
        ...
        private readonly int _Smoothing = Shader.PropertyToID("_Smoothing");
        ...
        [SerializeField]
        private CameraTextureSmoothing _smoothTex;
        ...
        private void OnRecognitionResult(FrameData frameData)
        {
            ...
            _material.SetTexture(_CameraTex, _smoothTex.texture);
