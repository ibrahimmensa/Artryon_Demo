...
namespace BNB.Makeup
{
    public class EyeFaceMakeup : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            BanubaSDKBridge.bnb_recognizer_insert_feature(BanubaSDKManager.instance.Recognizer, featureIds.eyes_correction, out error);
        ...
        private void OnDestroy()
        {
            var featureIds = BanubaSDKBridge.bnb_recognizer_get_features_id();
            IntPtr error = IntPtr.Zero;
            BanubaSDKBridge.bnb_recognizer_remove_feature(BanubaSDKManager.instance.Recognizer, featureIds.eyes_correction, out error);
            Utils.CheckError(error);
        }
