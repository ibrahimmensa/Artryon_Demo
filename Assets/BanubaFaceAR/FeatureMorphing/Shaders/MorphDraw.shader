    ...
    SubShader
    {
        ...
        {  
            ...
            v2f vert (appdata v)
            {
                ...
                float4 npush_scale = float4(NPUSH*float(_DrawID)/float(EXPAND_PASSES), scale*0.5 * _MorphWeight, (d1-d0)*0.5, (d0+d1)*0.5);
                ...
                float3 st_tex = tex2Dlod(_StaticPosTex, float4(1.-o.uv.x, o.uv.y, 0, 0)).xyz;
                float3 st_pos = st_tex;
